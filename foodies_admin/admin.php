        ...
        <section id="contents">
                ...
                <div class="cards" id="card2">
                    <a href="javascript:void(0)">
                        ...
                        <div class="infos">
                            ...
                            <p>
                                <?php
                                    $users = $connectdb->prepare("SELECT * FROM restaurants");
                                    $users->execute();
                                    echo $users->rowCount();
                                ?>
                            </p>
                ...
                <div class="add_user_form">
                    ...
                    <form method="POST" id="addItemForm" action="add_items.php" enctype="multipart/form-data">
                        <div class="inputs">
                            <div class="data">
                                <label for="restaurant">Restaurant</label><br>
                                <select name="menuRestaurant" id="menuRestaurant" required>
                                    <option value="" selected>Select Restaurant</option>
                                    <?php
                                        $select_restaurant = $connectdb->prepare("SELECT restaurant_name from restaurants ORDER BY restaurant_name");
                                        $select_restaurant->execute();
                        ...
                        <div class="inputs">
                            <div class="data">
                                ...
                                <select name="restaurantToDelete" id="restaurantToDelete" required>
                                    <option value="" selected>Select Restaurant</option>
                                    <?php
                                        $select_restaurant = $connectdb->prepare("SELECT restaurant_name from restaurants ORDER BY restaurant_name ASC");
                                        $select_restaurant->execute();
                                        $rows = $select_restaurant->fetchAll();
                                        foreach($rows as $row):
                                    ?>
            ...
            <div id="menuList" class="management">
                ...
                <table id="menuTable">
                    ...
                    <?php
                        $n = 1;
                        $select_restaurant = $connectdb->prepare("SELECT * FROM menu ORDER BY restaurant_name");
                        ...
                        <tr>
                            ...
                            <td class="prices">
                                <form method="POST" action="change_price.php">
                                    ...
                                    <input type="text" name="item_prize" id="item_prize" value="<?php echo $row->item_prize;?>"><button type="submit" name="change_prize" id="changePrize"><i class="fas fa-check"></i></button>
                                </form>
                            </td>
                        </tr>
                    </tbody>
            ...
            <div id="customers" class="management">
                ...
                <table id="customerTable">
                    ...
                    <?php
                        $n = 1;
                        $select_customer = $connectdb->prepare("SELECT * FROM users ORDER BY first_name");
            ...
            <div id="orderList" class="management">
                ...
                <table id="orderTable">
                    ...
                    <?php
                        $n = 1;
                        $select_order = $connectdb->prepare("SELECT users.first_name, users.last_name, users.email, orders.order_id, orders.customer_email, orders.item_name, orders.quantity, orders.item_price, orders.restaurant, orders.order_date, orders.order_time FROM users, orders WHERE users.email = orders.customer_email AND orders.order_status = 0 ORDER BY orders.order_time");
                ...
                <div class="new_data">
                    ...
                    <table id="deliveriesTable">
                        ...
                        <?php
                            ...
                            $select_deliveries = $connectdb->prepare("SELECT users.first_name, users.last_name, users.email, orders.order_id, orders.customer_email, orders.item_name, orders.quantity, orders.item_price, orders.restaurant, orders.order_date, orders.delivery_date FROM users, orders WHERE users.email = orders.customer_email AND orders.order_status = 1 AND orders.delivery_date = CURDATE() ORDER BY orders.order_date");
